...
#ifndef __DT_BINDINGS_RV1103B_PM_H__
#define __DT_BINDINGS_RV1103B_PM_H__
/******************************bits ops************************************/
...
/* the wake up source */
#define RKPM_GPIO0_WKUP_EN		BIT(0)
#define RKPM_SDMMC0_WKUP_EN		BIT(1)
#define RKPM_SDIO_WKUP_EN		BIT(2)
#define RKPM_USBDEV_WKUP_EN		BIT(3)
#define RKPM_UART0_WKUP_EN		BIT(4)
#define RKPM_PWM0_WKUP_EN		BIT(5)
#define RKPM_TIMER_WKUP_EN		BIT(6)
#define RKPM_HPTIMER_WKUP_EN		BIT(7)
#define RKPM_SYS_INT_WKUP_EN		BIT(8)
